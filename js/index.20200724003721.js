...
r=function(){dpi=window.devicePixelRatio;$('.js6').attr('src', (dpi>1) ? 'images/circle-cropped-150-1.png' : 'images/circle-cropped-75-1.png');
...
$('.js7').attr('src', 'images/instagram-26-1.png');
$('.js8').attr('src', 'images/twitter-26-1.png');
